...
NER Preprocessing классы и методы для NER обработки СМИ на азербайджанском языке.
...
## 🚀 Быстрый старт (проекта)
  ...
  1. Клонировать репозиторий: git clone https://github.com/ElizavetaMaz/NER_autumn_2025
  2. Перейти в репозиторий: cd NER_autumn_2025
